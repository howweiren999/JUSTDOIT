...
class ScheduleHistory :AppCompatActivity() {
    lateinit var historyRecord:ArrayList<ScheduleList>
    ...
    override fun onCreate(savedInstanceState:Bundle?){
        ...
        historyRecord=ArrayList<ScheduleList>()
        adapter=ScheduleAdapter(this)
        adapter.setHistoryRecords(historyRecord)

        val recyclerView=findViewById<RecyclerView>(R.id.schedule_historyview)
    ...
    private fun syncHistory() {
        ...
        val url = getString(R.string.url_server) + getString(R.string.url_scheduleList_read) + "?userName=" + userName
                ...
                try{
                    if(response != null){
                        ...
                        for(i in 0 until size){
                            ...
                            var hist: ScheduleList = ScheduleList(jsonUser.getString("date"),
                                jsonUser.getString("message"), jsonUser.getString("userName"),jsonUser.getString("createdDate"))
